...
import { pendingOperationId, requiresSnapshotRefresh, resolveApiError, resolveClimateReceipt } from "./hausman-hub-error-taxonomy.js?v=1.52.246";
import { withCorrelationId } from "./hausman-hub-correlation.js?v=1.52.246";
import { renderClimateSide } from "./hausman-hub-climate-side.js?v=1.52.246";
