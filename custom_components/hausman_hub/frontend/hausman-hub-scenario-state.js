...
import { eventDataFromDraft } from "./hausman-hub-scenario-fields.js?v=1.52.287";
import { scenarioDisplayGroup, scenarioDisplayText } from "./hausman-hub-scenario-catalog.js?v=1.52.287";
import { applyScenarioRoomIds, scenarioRoomIds } from "./hausman-hub-scenario-rooms.js?v=1.52.287";
