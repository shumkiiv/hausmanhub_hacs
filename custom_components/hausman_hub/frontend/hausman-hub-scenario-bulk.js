...
import { applyScenarioRoomIds, scenarioRoomOptions } from "./hausman-hub-scenario-rooms.js?v=1.52.286";
import { normalizedScenario, scenarioPayload } from "./hausman-hub-scenario-state.js?v=1.52.286";
