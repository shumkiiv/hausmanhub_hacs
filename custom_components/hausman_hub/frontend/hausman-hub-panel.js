import { renderHomeSection } from "./hausman-hub-home-sections.js?v=1.52.52";
import { renderFirstRunRoom } from "./hausman-hub-room-setup.js?v=1.52.52";
import { renderFirstRunDeviceGroups } from "./hausman-hub-room-device-groups.js?v=1.52.52";
import { resolveControlChannelTest, summarizeControlChannelReceipts } from "./hausman-hub-control-channel.js?v=1.52.52";
import { renderFirstRunClimateSources } from "./hausman-hub-room-climate-sources.js?v=1.52.52";
import { renderDeviceInventory } from "./hausman-hub-device-inventory.js?v=1.52.52";
import { loadDeviceBindings, renderDeviceBindingCallout, renderDeviceBindings } from "./hausman-hub-device-bindings.js?v=1.52.52";
import { closeFirstRunAreaCreator, createFirstRunArea, openFirstRunAreaCreator, renderFirstRunAreaBinding } from "./hausman-hub-area-binding.js?v=1.52.52";
import { createKioskButton, createKioskDock, handleKioskPointerUp, openIntercomFromRail, openRoomFromOverview, PANEL_SECTIONS, renderOverviewNavigationSummary, resolveIntercomQuickAction, restoreNavigationFromLocation, SECTION_SUBTITLES, setKioskState, writeNavigationRoute } from "./hausman-hub-navigation.js?v=1.52.52";
import { loadEnergyHistory, renderEnergyOverviewCard, renderEnergySection, saveEnergySettings } from "./hausman-hub-energy.js?v=1.52.52";
import { applyHomeSignalSelection, AWAY_MODE_EXPLANATION, AWAY_MODE_TYPE, createHeatingTemperatureFields, createPriorityChoicePicker, homeEnvironmentSaveError, homeEnvironmentSourcePayload, HOME_SIGNAL_BINDINGS, isAwayModeCandidate, isCentralHeatingCandidate, signalCandidateDisplayName } from "./hausman-hub-weather-sources.js?v=1.52.52";
import { renderMediaDeviceCard } from "./hausman-hub-media-device.js?v=1.52.52";
import { renderScenarioSection } from "./hausman-hub-scenarios.js?v=1.52.52";
import { renderClimateOverview } from "./hausman-hub-climate-overview.js?v=1.52.52";
import { renderLightingOverview } from "./hausman-hub-lighting.js?v=1.52.52";
import { renderRoomsOverview } from "./hausman-hub-rooms.js?v=1.52.52";
import { renderMediaOverview } from "./hausman-hub-media-overview.js?v=1.52.52";
import { renderSecurityOverview } from "./hausman-hub-security-overview.js?v=1.52.52";
import { renderDevicesOverview } from "./hausman-hub-devices-overview.js?v=1.52.52";
import { buildDiagnosticChecks, diagnosticSummaryText, renderDiagnosticDetails } from "./hausman-hub-diagnostics.js?v=1.52.52";
import { renderRolloutReadiness } from "./hausman-hub-rollout.js?v=1.52.52";
import { overviewHeroRenderKey } from "./hausman-hub-overview-hero-state.js?v=1.52.52";
import { renderOverviewContent, renderOverviewHero } from "./hausman-hub-overview.js?v=1.52.52";
import { renderPhysicalDeviceCard } from "./hausman-hub-device-card.js?v=1.52.52";
import { recordTechnicalEvent as log, renderTechnicalLogCard } from "./hausman-hub-technical-log.js?v=1.52.52";
import { applyFeedback } from "./hausman-hub-feedback.js?v=1.52.52";
import { renderKiosk } from "./hausman-hub-kiosk.js?v=1.52.52";
import { captureRoomValidation, clearFirstRunDraft, persistFirstRunDraft, reconcileRoomValidation, restoreFirstRunDraft, resumeFirstRunDraft } from "./hausman-hub-first-run-draft.js?v=1.52.52";
import { applyTabletProfile, isIntercomQuickAccessVisible, renderAppearanceSettings, renderIntercomSettings, syncIntercomQuickAccess } from "./hausman-hub-settings-profile.js?v=1.52.52";
import { renderSettingsRooms, saveRoomType } from "./hausman-hub-settings-rooms.js?v=1.52.52";

const PANEL_API = "hausman_hub/v1/admin/panel";
const PANEL_CSS_URL = "/api/hausman_hub/panel/hausman-hub-panel.css?v=1.52.52";
