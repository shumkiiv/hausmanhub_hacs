...
import { scenarioAffectedDeviceCount, scenarioRoomIds, scenarioRoomLabels, scenarioRoomOptions as roomOptions } from "./hausman-hub-scenario-rooms.js?v=1.52.285";
import { renderScenarioBulkTools } from "./hausman-hub-scenario-bulk.js?v=1.52.285";
