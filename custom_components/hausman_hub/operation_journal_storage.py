...
class HomeAssistantOperationJournalArchiveStore:
    """Persist immutable journal archive metadata separately from live records."""

    def __init__(self, hass: HomeAssistant, entry_id: str) -> None:
        self._store: Store[dict[str, object]] = Store(
            hass, 1, f"hausman_hub.operation_journal_archives.{entry_id}"
        )
