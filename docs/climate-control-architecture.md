...
Версия документа: 2026-07-17. Реализация относится к HASC 0.5.1.
...
и закрыться при неизвестной версии, а не угадывать форму ответа.
...
1. Установить HASC 0.5.1, оставить climate bridge в `disabled`.
...
0.5.1 подготавливает операторский и проверяемый HASC backend; переключение
