...
Версия документа: 2026-07-18. Реализация относится к HASC 0.5.5.
...
добавлены query и response схемы shadow evidence, а в 0.5.5 — query и response
схемы canary preflight. Всего устанавливается двенадцать схем.
...
1. Установить HASC 0.5.5, оставить climate bridge в `disabled`.
...
0.5.5 добавляет поверх операторского экрана машинно проверяемый local-admin
preflight со сроком свежести; переключение
