...
Версия документа: 2026-07-18. Реализация относится к HASC 0.5.4.
...
1. Установить HASC 0.5.4, оставить climate bridge в `disabled`.
...
0.5.4 добавляет поверх подготовленного registry единый неактивирующий
one-room preflight; переключение
