...
Версия документа: 2026-07-17. Реализация относится к HASC 0.5.3.
...
1. Установить HASC 0.5.3, оставить climate bridge в `disabled`.
...
6. Проверить неактивный [one-room rollout
...
0.5.3 подготавливает registry без ручного копирования private IDs и измеримый
shadow gate HASC; переключение
