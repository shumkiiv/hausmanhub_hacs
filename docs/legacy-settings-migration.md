...
Распознаны, но требуют отдельного нативного владельца и storage-модели:
...
- создать версионированный `HausmanHubSettingsStore` для световых и медиа
  пресетов, отчётов и календаря штор;
