...
class PanelJavaScriptContractTest(unittest.TestCase):
    ...
    def test_tablet_library_pages_share_one_canonical_hero(self) -> None:
        ...
        self.assertIn("hausman-hub-library-hero.css?v=1.52.170", panel_styles)
    ...
    def test_panel_script_exists_and_stays_bounded(self) -> None:
        ...
        self.assertIn("hausman-hub-overview-utility-cards.js?v=1.52.170", overview)
        self.assertLessEqual(len(room_icons.encode("utf-8")), 12 * 1024)
        self.assertIn('hausman-hub-rollout.js?v=1.52.170', content)
        ...
        self.assertIn("hausman-hub-inventory-duplicates.js?v=1.52.170", device_inventory)
        self.assertLessEqual(
        ...
        self.assertIn('hausman-hub-energy-chart.js?v=1.52.170', energy)
        self.assertLessEqual(
        ...
        self.assertIn("hausman-hub-scenario-catalog.js?v=1.52.170", scenarios)
        self.assertLessEqual(len(scenario_device_picker.encode("utf-8")), 16 * 1024)
        self.assertIn("hausman-hub-scenario-device-picker.js?v=1.52.170", scenarios)
        ...
        self.assertIn('hausman-hub-scenario-fields.js?v=1.52.170', scenarios)
    ...
    def test_overview_hero_uses_tablet_semantic_room_icons(self) -> None:
        ...
        self.assertIn(
            './hausman-hub-room-icons.js?v=1.52.170',
    ...
    def test_panel_styles_are_local_and_stay_bounded(self) -> None:
        ...
        self.assertIn('hausman-hub-buttons.css?v=1.52.170', styles)
        self.assertIn('hausman-hub-energy-chart.css?v=1.52.170', styles)
        self.assertLessEqual(len(rollout_styles.encode("utf-8")), 4 * 1024)
        self.assertIn('"/api/hausman_hub/panel/hausman-hub-panel.css?v=1.52.170"', content)
        ...
        self.assertIn('hausman-hub-settings.css?v=1.52.170', styles)
        self.assertIn('hausman-hub-diagnostics.css?v=1.52.170', styles)
        self.assertIn('hausman-hub-switch.css?v=1.52.170', styles)
        self.assertIn('hausman-hub-notice.css?v=1.52.170', styles)
        ...
        self.assertIn('hausman-hub-device-maintenance.css?v=1.52.170', styles)
        self.assertIn('hausman-hub-control-channel.css?v=1.52.170', styles)
        ...
        self.assertIn('hausman-hub-weather-sources.css?v=1.52.170', styles)
        self.assertIn('hausman-hub-wizard-validation.css?v=1.52.170', styles)
        self.assertIn('hausman-hub-catalog.css?v=1.52.170', styles)
        self.assertIn('hausman-hub-media-device.css?v=1.52.170', styles)
        self.assertIn('hausman-hub-device-card.css?v=1.52.170', styles)
        self.assertIn('hausman-hub-device-controls.css?v=1.52.170', styles)
        ...
        self.assertIn('hausman-hub-scenarios.css?v=1.52.170', styles)
        self.assertIn('hausman-hub-scenario-device-picker.css?v=1.52.170', scenario_styles)
        ...
        self.assertIn('hausman-hub-climate-overview.css?v=1.52.170', styles)
        self.assertIn('hausman-hub-navigation.css?v=1.52.170', styles)
        self.assertIn('hausman-hub-kiosk.css?v=1.52.170', styles)
        self.assertIn(".kiosk-panorama-metrics", kiosk_styles)
        self.assertIn(".kiosk-panorama-intercom", kiosk_styles)
        self.assertIn('hausman-hub-rollout.css?v=1.52.170', styles)
        ...
        self.assertEqual(
            {
                ...
                "module_url": "/api/hausman_hub/panel/hausman-hub-panel.js?v=1.52.170",
                "require_admin": True,
