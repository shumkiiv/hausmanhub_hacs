...
VENDORED_CONTRACT_HASHES = {
    ...
    "custom_components/hausman_hub/contracts/v1/dashboard-snapshot.schema.json": "a31619117e747027477350a31af04d1cf5aead81a8d6198e93f019299372672a",
...
def test_contract_0_50_0_vendored_files_match_canonical_hashes() -> None:
