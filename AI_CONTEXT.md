...
## Подготовлена кнопка возврата устройств в климатический контур, 2026-09-09
...
- Проверено локально: 39 тестов панели и 50 браузерных сценариев PASS.
  Изменение ещё не опубликовано и не установлено.
