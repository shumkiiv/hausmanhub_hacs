...
## Опубликована кнопка возврата устройств в климатический контур, 1.52.238, 2026-09-09
...
- Публичный выпуск `v1.52.238` создан из `184518c` без assets. Установка,
  restart и климатические действия не выполнялись: для них требуется отдельное
  поручение. Подробности: `docs/RELEASE_AUDIT_1.52.238.md`.
