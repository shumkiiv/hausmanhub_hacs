...
- Целевые проверки: 203 passed, семь файлов света, контракт 0.70.0 (8581cc9).
  ...
  по умолчанию не знает auxiliaries. Полный набор не запускался.
- Это локальная реализация, не новый выпуск и не приёмка живого дома.
  Разрешение на полный набор, выпуск и установку запрошено отдельно.
  ...
  workspace, docs/product/roadmap/evidence/HH-006-2026-09-16.md.
