...
- На сервере пока 1.52.232. Сохранены свежие защищённые архивы компонента
  и девяти климатических файлов, полный backup 5a41aef4 текущего дня HA.
  Публикацию, установку и read-only приёмку старой операции фиксирует корень.
