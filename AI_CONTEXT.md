...
- Следующий этап: независимый tester на конечном коммите, затем reviewer
  и security_auditor. Браузер после правки ещё не повторён. Новый комплект
  выпуска должен быть собран по исправленным байтам.
